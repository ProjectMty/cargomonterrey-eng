  ...
  return (
    <div className='flex h-screen flex-col bg-primary'>
      ...
      <div className='flex grow-[1] items-center justify-center'>
        <div className='flex w-11/12 flex-col items-center justify-center space-y-4 rounded-xl bg-white py-8 px-4 text-center shadow-xl sm:w-4/5 md:w-3/4 lg:w-3/5 xl:w-1/2 2xl:w-1/3'>
